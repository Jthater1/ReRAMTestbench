...
C {devices/vsource.sym} 380 600 0 0 {name=V8 value=0 savecurrent=false}
...
C {TIA_02.sym} 1450 590 0 0 {name=x2}
...
C {devices/vsource.sym} 1140 300 0 0 {name=V14 value=-1.8 savecurrent=false}
C {devices/lab_pin.sym} 1140 260 2 0 {name=p30 sig_type=std_logic lab=VSSNeg}
C {devices/gnd.sym} 1140 340 0 0 {name=l14 lab=GND}
...
mult=1}
C {sky130_fd_pr/corner.sym} 1270 740 0 0 {name=CORNER only_toplevel=false corner=ss}
C {devices/code_shown.sym} 1420 770 0 0 {name=SPICE only_toplevel=false value=".tran 1n 5u
.save all"}
C {devices/vsource.sym} 1230 300 0 0 {name=V15 value=0 savecurrent=false}
C {devices/lab_pin.sym} 1230 260 2 0 {name=p8 sig_type=std_logic lab=VSS}
C {devices/gnd.sym} 1230 340 0 0 {name=l15 lab=GND}
C {devices/lab_pin.sym} 1640 560 0 0 {name=p36 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 1960 550 1 0 {name=p37 sig_type=std_logic lab=INVOUT}
C {devices/lab_pin.sym} 1620 570 1 0 {name=p38 sig_type=std_logic lab=TIAOUT}
C {devices/lab_pin.sym} 1180 540 0 0 {name=p39 sig_type=std_logic lab=BLIN}
...
C {oneBitADC02.sym} 2130 550 0 0 {name=x4}
